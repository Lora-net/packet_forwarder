...
#define JIT_QUEUE_MAX           10  /* Maximum number of packets to be stored in JiT queue */
...
struct jit_node_s {
    ...
    /* Internal fields */
    bool is_sent;                   /* Indicates if queue node is available or not */
...
@param show_content[in] Indicates if nodes marked as "sent" have to be displayed or not
*/
